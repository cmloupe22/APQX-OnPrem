...
cluster-create: ## 🏗️  Create k3d cluster
...
check-tools: ## ✔️  Check if required tools are installed
	...
	@command -v helm >/dev/null 2>&1 && echo "$(GREEN)✅ helm$(NC)" || echo "$(YELLOW)⚠️  helm (optional)$(NC)"
